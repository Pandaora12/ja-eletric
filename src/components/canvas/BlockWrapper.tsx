...
import {
  ...
  DividerBlock, SignatureBlock, CalloutBlock, ImageBlock, CompanyHeaderBlock,
} from '../blocks';
import {
  isHeading, isParagraph, isTable,
  isDivider, isSignature, isCallout, isImage, isCompanyHeader,
} from '../../types/blocks';
...
function AddBlockMenu({ onAdd }: { onAdd: (type: Block['type']) => void }) {
  return (
    <div className="relative group/menu">
      ...
      <div className="absolute top-full left-0 mt-1 w-36 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded shadow-lg overflow-hidden hidden group-hover/menu:block">
